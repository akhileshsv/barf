...
func BmShrDz(b *RccBm, lsx, rsx float64, xs, vs []float64) (err error){
	...
	//if b.Verbose{
		//fmt.Println("shear links main->",b.Dlink, " mm dia at ", slink, "mm spacing", "net length->",mainlen,"m")
		//fmt.Println("shear links min->",b.Dlink, " mm dia at ", smin, "mm spacing", "net length->", minlen,"m")
		//fmt.Println("shear links nominal->",b.Dlink, " mm dia at ", snom, "mm spacing","net length->",nomlen,"m")
	//}
...
func BmShrChk(b *RccBm) (err error){
	...
	slink, smin, snom, err := LinkSpacing(fy, b.Bw, effd, b.Dlink, vusv, b.Nlegs)
	if err != nil{return}
	b.Lspc = []float64{slink, smin, snom}
	if vsmin + vc >= vcmax{
	...
	//fmt.Println("number of stirrups->",b.Nlx[0])
	err = nil
	return
