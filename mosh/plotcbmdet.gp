...
if (ARG2 eq "dxf") unset xtics; unset ytics; set font "Arial,0.001"
...
plot ARG1 index 0 using 1:2:3:4:5 w vectors nohead lc var lw 0.5 notitle,\
     ...
     ARG1 index 2 using 1:2:3:4:5 w vectors nohead lc var dt 2 lw 0.1 title "links",\
     ARG1 index 3 using 1:2:3:4 w labels offset char 1,1 tc var notitle,\
     ARG1 index 4 using 1:2:3:4:5 w vectors heads lc var lw 0.3 notitle
...
plot ARG1 index 0 using 1:2:3:4:5 w vectors nohead lc var lw 2 notitle,\
     ...
     ARG1 index 2 using 1:2:3:4:5 w vectors nohead lc var lw 0.5 dt 2 title "links",\
     ARG1 index 3 using 1:2:3:4 w labels offset char 1,1 tc var notitle,\
     ARG1 index 4 using 1:2:3:4:5 w vectors heads lc var lw 1 notitle
}
