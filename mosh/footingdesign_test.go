...
func TestFtngDzRojas(t *testing.T){
	...
	wantstring := `
example-1 c:\Users\Admin\junk\barf\data\examples\mosh\ftng\shah8.1.json8.1Shah
sloped footing
...
mux, vux, vp, rbr x- 72.38, 77.16, 672.00, 10, 150, 707, 14 x
muy, vuy, vp, rbr y- 90.78, 81.89, 672.00, 10, 150, 864, 56 y
example-2 c:\Users\Admin\junk\barf\data\examples\mosh\ftng\sub15.3.json15.3Sub
sloped footing
...
mux, vux, vp, rbr x- 429.92, 277.76, 1546.74, 10, 100, 2121, 56 x
muy, vuy, vp, rbr y- 429.92, 281.21, 1546.74, 10, 100, 2121, 25 y
example-3 c:\Users\Admin\junk\barf\data\examples\mosh\ftng\rojas1.json1Rojas
pad footing
...
cover - nominal 60.0 mm effective 80.0 mm
footing depth 680 mm
mux, vux, vp, rbr x- 640.36, 488.39, 1469.34, 12, 120, 3054, 35 x
muy, vuy, vp, rbr y- 591.90, 535.92, 1469.34, 12, 130, 2827, 5 y
example-4 c:\Users\Admin\junk\barf\data\examples\mosh\ftng\sub15.5.json15.5Sub
pad footing
...
mux, vux, vp, rbr x- 358.05, 286.62, 1219.45, 12, 160, 1923, 23 x
muy, vuy, vp, rbr y- 308.59, 341.41, 1219.45, 12, 170, 1696, 38 y
`
	if rezstring != wantstring{
