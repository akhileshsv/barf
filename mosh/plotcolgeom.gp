...
plot ARG1 index 0 using 1:2:3:4:5 w vectors nohead lw 2 lc var notitle,\
     ARG1 index 0 using ($1+$3)/2:($2+$4)/2:6 w labels notitle,\
     ARG1 index 1 using 1:2:3 w labels offset char 1,1 notitle,\
     ARG1 index 2 using 1:2 w points pt 15 title "bars",\
     ARG1 index 3 using 1:2 w lines dt 0 title "n.a",\
     ARG1 index 4 using 1:2:3:4 w vectors nohead dt 0 title "tie"
} else {
plot ARG1 index 0 using 1:2:3:4:5 w vectors nohead lw 2 lc var notitle,\
     ...
     ARG1 index 2 using 1:2:3:4 w ellipses title "bars",\
     ARG1 index 3 using 1:2 w lines dt 0 title "n.a",\
     ARG1 index 4 using 1:2:3:4 w vectors nohead lw 1 dt 0 title "tie"
}
