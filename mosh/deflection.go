...
func BmSdratBs(b *RccBm, mspan float64) (sdchk bool, sd, dserve float64){
	...
	if b.Verbose{
		fmt.Println("b.Fck, b.Fy, b.Lspan, b.Tyb, b.Bw, b.Bf, b.Df, effd, astprov, astreq, asc, mspan, b.DM, mtyp, b.Endc-\n",b.Fck, b.Fy, b.Lspan, b.Tyb, b.Bw, b.Bf, b.Df, effd, astprov, astreq, asc, mspan, b.DM, mtyp, b.Endc)
		fmt.Println("mspan, astprov, asc->",mspan, astprov, asc)
		fmt.Println("sdchk,sd,dserve,effd->",sdchk, sd, dserve, effd)
	}
	return
}
