...
type RccFlr struct {
	...
	Bmz       map[string]RccBm
	Colz      map[string]RccCol
	Slbz      map[string]RccSlb
	...
	Ftngz     map[string]RccFtng //ftngs.
...
//Init inits a RccFlr with defaults
func (f *RccFlr) Init()(err error){
