...
unset colorbox
set view 60, 30, 1, 1
splot ARG1 index 0 using 1:3:2:4 w labels tc rgb "dark-cyan" point lc rgb "purple" pt 7 offset char 2,2 title "nodes",\
      ARG1 index 1 using 1:3:2:($4-$1):($6-$3):($5-$2):7 w vectors nohead lc var lw 3 title "mems",\
      ARG1 index 1 using ($1+$4)/2:($3+$6)/2:($5+$2)/2:7 w labels offset 1,1 title "mems",\
      ARG1 index 2 using 1:3:2 w points pt 9 ps 2 title "sups",\
      ARG1 index 3 using 1:3:2:4:6:5:7 w vectors lc var lw 1 title "load",\
      ARG1 index 4 using 1:3:2:4:6:5:7 w vectors nohead lc var lw 1 notitle,\
      ARG1 index 5 using 1:3:2:4 w labels tc var offset 2,2 notitle,\
      ARG1 index 6 using 1:3:2 w points ps 3 title "moment" 
